...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'نظام التقارير المصورة'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This URL is used to generate URLs to your application's assets. For
    | example, if you have a CDN, you might set this to the CDN's URL.
    |
    */
