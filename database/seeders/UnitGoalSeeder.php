    ...
    public function run(): void
    {
        ...
        $unitGoalsData = [
            'النظافة العامة' => [
                ...
                // الهدف القابل للقياس: كنس وغسل جميع الساحات العامة 3 مرات يوميًا ضمن وجبات العمل (صباحية من 7 ص إلى 2 م، مسائية من 2 م إلى 9 م، ليلية من 9 م إلى 7 ص) بنسبة التزام لا تقل عن 95%، وإزالة الأوساخ والمخلفات من جميع النقاط المحددة كل ساعتين على مدار 24 ساعة بنسبة لا تقل عن 98%.
                'كنس وغسل جميع الساحات العامة 3 مرات يوميًا ضمن وجبات العمل (صباحية من 7 ص إلى 2 م، مسائية من 2 م إلى 9 م، ليلية من 9 م إلى 7 ص) بنسبة التزام لا تقل عن 95%، وإزالة الأوساخ والمخلفات من جميع النقاط المحددة كل ساعتين على مدار 24 ساعة بنسبة لا تقل عن 98%.',
